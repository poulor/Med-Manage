...
public class Main {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Administrator a = new Administrator("first_name", "middle_name", "last_name", "gender", "02/22/1922", "800000000", "street", 10000, "email", "username", "password", "user_type", "10/21/1995");
        Doctor d = new Doctor("first_name", "middle_name", "last_name", "gender", "03/25/1983", "phone_number", "street", 12000, "email", "username", "password", "user_type", "03/11/2005", "specialty", "department");
        Receptionist r = new Receptionist("first_name", "middle_name", "last_name", "gender", "05/23/1994", "phone_number", "street", 13045, "email", "username", "password", "user_type", "08/05/2008");
